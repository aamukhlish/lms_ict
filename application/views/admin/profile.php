...
<div class="row">
  <div class="col-md-3">
    ...
    <div class="box box-danger">
      <div class="box-body box-profile">
        <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url('assets/template/back/dist') ?>/img/user2-160x160.jpg" alt="User profile picture">
  ...
  <div class="col-md-9">
	...
	<?php if ($this->session->flashdata('something')) {?>
    		...
    		<div class="alert alert-success alert-dismissible" > <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>  <?php echo $this->session->flashdata('something'); ?> </div>
